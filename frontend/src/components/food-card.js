                ...
                <div className="food-category-container mt-5">
                    ...
                    <div className="food-category-section mt-3 ">
                        <div className="food-card mb-sm-0">
                            <a href="/"><img src="https://img.perceptpixel.com/pykhlszs/indian-cuisine.webp" className="img-w-100 border-rounded food-cat-card-img" alt="Food Category"/></a>
                            <div className="card-name">
                                <a className="a-tag-style" href="/">Indian</a>
                            </div>
                        </div>
                        <div className="food-card mb-sm-0">
                            <a href="/"><img src="https://img.perceptpixel.com/pykhlszs/chinese-cuisine.webp" className="img-w-100 border-rounded food-cat-card-img" alt="Food Category"/></a>
                            <div className="card-name">
                                <a className="a-tag-style" href="/">chinese</a>
                            </div>
                        </div>
                        <div className="food-card mb-sm-0">
                            <a href="/"><img src="https://img.perceptpixel.com/pykhlszs/italian-cuisine.webp" className="img-w-100 border-rounded food-cat-card-img" alt="Food Category"/></a>
                            <div className="card-name">
                                <a className="a-tag-style" href="/">Italian</a>
                            </div>
                        </div>
                    </div>
                </div>
