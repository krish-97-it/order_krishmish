<nav className="navbar navbar-expand-md navbar-custom-style bg-dark navbar-dark fixed-top">
    <div className="container-fluid">
        <a className="navbar-brand" href="//"><img src={Brandlogo} alt="Brand" height="60px" width="60px"/></a>
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="/abc" aria-controls="/abc" aria-expanded="false" aria-label="Toggle navigation">
