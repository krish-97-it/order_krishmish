...
export default function SearchBar({searchItem, getSearchInput, clearInput, getInputCuisine}){
    ...
    return(
        ...
        <div className="container search-form-container" id="searchformid" search-bar-hide={(currentPath === '/special-combos' || currentPath === '/mycart' || currentPath === '/reviews') ? 'on' : 'off'} >
